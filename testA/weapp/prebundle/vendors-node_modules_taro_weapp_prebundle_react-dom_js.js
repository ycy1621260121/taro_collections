...
/* harmony import */ var _chunk_QXCD76IY_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-QXCD76IY.js */ "./node_modules/.taro/weapp/prebundle/chunk-QXCD76IY.js");
/* harmony import */ var _chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-ME7YP2RG.js */ "./node_modules/.taro/weapp/prebundle/chunk-ME7YP2RG.js");
...
(0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.init_shared_esm)();
(0,_chunk_QXCD76IY_js__WEBPACK_IMPORTED_MODULE_1__.init_runtime_esm)();
...
function updateProps(dom, oldProps, newProps) {
    ...
    const isFormElement = dom instanceof _chunk_QXCD76IY_js__WEBPACK_IMPORTED_MODULE_1__.FormElement;
    for(i in newProps){
...
function setEvent(dom, name, value, oldValue) {
    ...
    const compName = (0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.capitalize)((0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.toCamelCase)(dom.tagName.toLowerCase()));
    if (eventName === "click" && compName in _chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.internalComponents) {
        eventName = "tap";
    }
    if ((0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(value)) {
        if (oldValue) {
...
function setStyle(style, key, value) {
    ...
    style[key] = (0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.isNumber)(value) && IS_NON_DIMENSIONAL.test(key) === false ? value + "px" : value == null ? "" : value;
}
function setProperty(dom, name, value, oldValue) {
    ...
    if (name === "key" || name === "children" || name === "ref") ;
        ...
        if ((0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.isString)(value)) {
            style.cssText = value;
        } else {
            if ((0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.isString)(oldValue)) {
                style.cssText = "";
                oldValue = null;
            }
            if ((0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(oldValue)) {
            ...
            if ((0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(value)) {
    ...
    } else if (!(0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(value)) {
        if (value == null) {
...
var hostConfig = {
    createInstance (type) {
        return _chunk_QXCD76IY_js__WEBPACK_IMPORTED_MODULE_1__.document$1.createElement(type);
    },
    createTextInstance (text) {
        return _chunk_QXCD76IY_js__WEBPACK_IMPORTED_MODULE_1__.document$1.createTextNode(text);
    },
    ...
    prepareUpdate () {
        return _chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.EMPTY_ARR;
    },
    ...
    unhideInstance (instance, props) {
        ...
        display = display == null || (0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.isBoolean)(display) || display === "" ? "" : ("" + display).trim();
    ...
    queueMicrotask: !(0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.isUndefined)(Promise) ? (callback)=>Promise.resolve(null).then(callback).catch(function(error) {
            setTimeout(()=>{
                throw error;
            });
        }) : setTimeout,
    ...
    resetAfterCommit: _chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    commitMount: _chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    now,
    cancelTimeout: clearTimeout,
    scheduleTimeout: setTimeout,
    preparePortalMount: _chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    noTimeout: -1,
...
function unmountComponentAtNode(dom) {
    (0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.ensure)(dom && [
        1,
        8,
        9,
        11
...
var portalType = (0,_chunk_ME7YP2RG_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(Symbol) && Symbol.for ? Symbol.for("react.portal") : 60106;
